<div>
    ...
    <div class="document-preview">
        ...
        <div class="document-preview-content">
            ...
            <div class="document-body">
                ...
                <div class="document-content">
                    ...
                    <p>&emsp;&emsp;This is to certify that {{ $salutation }} {{ $fullName }}, whose personal data
                        appears below, is a <b>RESIDENT</b> of this Barangay and personally known with good moral
                        character, law-abiding citizen, and has a respectable reputation in this community.</p>

                    <div class="resident-information">
                        <div>
                            <span class="key">Date of birth</span><span
                                class="colon">:</span>&nbsp;{{ $dob }}
                        </div>
                        <div>
                            <span class="key">Civil status</span><span
                                class="colon">:</span>&nbsp;{{ $civilStatus }}
                        </div>
                        <div>
                    ...
                    <p>&emsp;&emsp;This certification issued upon the request of the aforementioned individual for
                        whatever legal purpose it may serve best.</p>

                    <p>&emsp;&emsp;Signed this {{ $dayOfCreation }} day of {{ $monthOfCreation }},
                        {{ $yearOfCreation }}, Barangay {{ $barangayName }}, {{ $city }},
        ...
        <div class="document-preview-button-footer">
            ...
            {{-- <button class="document-preview-request-btn" onclick="sendRequest('/api/document', {{ $dataToSend }})">
                Request
            </button> --}}
        </div>
    </div>
