...
@section('content')
    <div class="statistics-container">
        <x-icon-header text="Statistics" iconResourcePath='resources/img/sidebar-icons/statistics-sblogo-inactive.png'
            isBrown />
        ...
        <div class="statistics-grid">
            @if ($features->contains('name', 'residents_enabled'))
                <div class="stat-item">
                    {{-- Residents Icon --}}
                    <img src="{{ Vite::asset('resources/img/statistics-icon/house-icon.png') }}" alt="Residents Icon"
                        class="stat-icon">
            ...
            @if ($features->contains('name', 'households_enabled'))
                <div class="stat-item">
                    {{-- Households Icon --}}
                    <img src="{{ Vite::asset('resources/img/statistics-icon/house-icon.png') }}" alt="Households Icon"
                        class="stat-icon">
            ...
            @if ($features->contains('name', 'gender_enabled'))
                <div class="stat-item">
                    ...
                    <div class="gender-header">
                        <img src="{{ Vite::asset('resources/img/statistics-icon/gender-icon.png') }}" alt="Gender Icon"
                            class="stat-icon">
            ...
            @if ($features->contains('name', 'age_demographics_enabled'))
                <div class="stat-item">
                    {{-- Children Icon --}}
                    <img src="{{ Vite::asset('resources/img/statistics-icon/child-icon.png') }}" alt="Children Icon"
                        class="stat-icon">
                    <h3>Children</h3>
                ...
                <div class="stat-item">
                    {{-- Adults Icon --}}
                    <img src="{{ Vite::asset('resources/img/statistics-icon/adult-icon.png') }}" alt="Adults Icon"
                        class="stat-icon">
                    <h3>Adults</h3>
                ...
                <div class="stat-item">
                    ...
                    <img src="{{ Vite::asset('resources/img/statistics-icon/old-icon.png') }}" alt="Senior Citizens Icon"
                        class="stat-icon">
...
@section('styles')
    @vite(['resources/css/barangay_role/statistics/statistics.css', 'resources/css/components/icon-header.css'])
@endsection
